                ...
                <div class="col-md-6 align-self-center" id="profile_form" style="margin-left: 25%">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Role</h3> &nbsp; <small class="text-dark">(update only role
                                permissions and type)</small>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{route('admin.role.update')}}">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                     $permissions = Spatie\Permission\Models\Permission::where('type','=','FrontEnd')->get() ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2" name="permissions[]" multiple="multiple"
                                                ...
                                                <option value="{{$value->name}}"
                                                    {{$role->getAllPermissions()[$key]->name == $value->name ? 'selected' : ''}}>
                                                    {{$value->name}}</option>
                                                @else
