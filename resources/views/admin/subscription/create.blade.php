              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <input type="number" min="1" name="valid_property" class="form-control" placeholder="Enter a valid property.." required>
                  </div>
                    </div>
                    <div class="col-sm-6">
                          <div class="form-group">
                   ...
                   <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="summernote" class="form-control description" name="description" rows="3" cols="30" placeholder="Enter ..."></textarea>
                      </div>
                    </div>
                  </div>
                </div>
