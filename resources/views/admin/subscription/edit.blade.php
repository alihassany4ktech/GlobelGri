                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" name="valid_property" class="form-control"
                                                value="{{$subscription->valid_property}}" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="agent_role" style="width: 100%;"
                                                autocomplete="off">
                                                <option value="{{$subscription->agent_role}}" selected>
                                                    {{$subscription->agent_role}}</option>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="summernote" class="form-control description"
                                                ...
                                                cols="30">{{$subscription->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
