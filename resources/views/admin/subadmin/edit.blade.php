              ...
              <form id="agentform">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" value="{{$subAdmin->email}}" required>
                  </div>
                  <div class="form-group">
                  ...
                  <label>Role</label>
                        <select name="role_name" class="selectpicker form-control"
                                                ...
                                                @if ($subAdmin->getRoleNames()->isEmpty())
                                                <option disabled selected>No Role</option>
                                                @else
                                                <option value="{{$subAdmin->getRoleNames()[0]}}" selected>
                                                    {{$subAdmin->getRoleNames()[0]}}</option>
                                                @foreach ($roles as $role)
                                                @if ($subAdmin->getRoleNames()[0] == $role->name )
