                    ...
                    <div class="accountData">
                        ...
                        <div class="propertiesList">
                            ...
                            <article class="propertyRow">
                                ...
                                <div class="btnArea">
                                    <a type="button" href="{{url('/subscription/purchase/'.$row->id)}}"
                                        class="status fontNeuron btn"
                                        style="border:none ;background: #f1c967;  background: -webkit-linear-gradient(to right, #bd7f0a, #f1c967); background: linear-gradient(to right, #bd7f0a, #f1c967);">Purchase</a>
                                </div>
                            </article>
                            @endforeach
