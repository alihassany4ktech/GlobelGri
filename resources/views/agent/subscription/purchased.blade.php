                              ...
                              <div class="propertiesList">
                                  ...
                                  <div class="info">
                                    ...
                                    <div class="textBox">
                                      ...
                                      <address>Valid Property <span class="text-info"> {{$purchasedSubscription->valid_property}} </span></address>
                                      <div class="priceArea">
                                        <span class="price fontNeuron">${{$purchasedSubscription->price}}</span>
                                        <time class="date" datetime="2017-02-27">{{$purchasedSubscription->created_at->format('Y-m-d')}}</time>
                                      </div>
                                  ...
                                  {{-- <div class="btnArea">
                                    <a type="button" href="{{url('/subscription/purchase/'.$purchasedSubscription->id)}}" class="status fontNeuron btn" style="border:none ;background: #f1c967;  background: -webkit-linear-gradient(to right, #bd7f0a, #f1c967); background: linear-gradient(to right, #bd7f0a, #f1c967);">Purchase</a>
                                  </div> --}}
                                </article>
