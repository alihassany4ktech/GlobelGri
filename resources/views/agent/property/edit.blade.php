                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bedroom" class="form-control" value="{{$property->bedroom}}" min="0"
                                            ...
                                            <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bathroom" class="form-control" value="{{$property->bathroom}}" min="0"
                                            ...
                                            <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="garages" class="form-control" value="{{$property->garages}}" min="0"
                                ...
                                <div class="addProperty">
                                    ...
                                    <div class="formContent">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="private_note">{{$property->private_note}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="btnArea">
