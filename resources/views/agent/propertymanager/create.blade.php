                ...
                <div class="col-xs-12 col-sm-8 col-lg-9">
                    ...
                    <div class="accountData">
                        <form id="agentForm">
                            ...
                            <div class="head">
                                <h4 class="fontNeuron">Add Property Manager</h4>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Password..." id="itemN-10"
                                                    name="password">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="role_name" class="form-control" style="width: 100%" data-placeholder="Choose" required>
                                                           <option value="Property Manager" selected>Property Manager</option>                                           
                                                </select>
    ...
    $(document).ready(function () {
        ...
        $('#agentForm').on('submit', function (event) {
            ...
            $.ajax({
                ...
                url: '{{route("agent.store.propertyManager")}}',
                method: 'post',
                processData: false,
                contentType: false,
                data: formData,
