    ...
    <section class="slick-fade slickSlider introSlider">
        <div>
            ...
            <article class="introSlide bgCover" id="cover"
                style="background-image: url({{asset('frontend/images/co.jpg')}});background-position:0px -360px ;background-repeat: no-repeat;  background-attachment: fixed;">
                    ...
                    <div class="slickSlider testimonial-carousel testimonialSlider">
                        <div>
                            ...
                            <div class="testimonialColumn text-center">
                                <img src="{{asset('frontend/images/m6.jpg')}}" alt="image description"
