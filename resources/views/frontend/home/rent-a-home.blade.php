    ...
    <section class="slick-fade slickSlider introSlider">
        <div>
            ...
            <article class="introSlide bgCover" id="cover"
                style="background-image: url({{asset('frontend/images/m7.jpg')}});background-position: -0px -20px ;background-repeat: no-repeat;  background-attachment: fixed;">
                    ...
                    <div class="slickSlider testimonial-carousel testimonialSlider">
                        <div>
                            ...
                            <div class="testimonialColumn text-center">
                                <img src="{{asset('frontend/images/m0.jpg')}}" alt="image description"
